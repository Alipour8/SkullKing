...
void maindatabase::score( user in_user ,int score)
{
    QFile Db("MainDatabase.json") ;
    if( !Db.open(QIODevice::ReadOnly))
    {
...
void maindatabase::addwin( user in_user)
{
    QFile Db("MainDatabase.json") ;
    if( !Db.open(QIODevice::ReadOnly))
    {
...
void maindatabase::addlost( user in_user)
{
    QFile Db("MainDatabase.json") ;
    if( !Db.open(QIODevice::ReadOnly))
    {
